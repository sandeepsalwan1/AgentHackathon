...
export const publicArrivalActionSchema = z.discriminatedUnion("action", [
  z.object({
...
export const arrivalDeskPatchSchema = z.discriminatedUnion("action", [
  z.object({
...
export async function publicArrivalSettings(clinicId: string) {
  return {
    settings: await getArrivalSettings({ clinicId })
  };
}

export async function arrivalDeskPayload(clinicId: string) {
...
export async function applyPublicArrivalAction(
  clinicId: string,
...
export async function applyArrivalDeskPatch(
  clinicId: string,
  actor: Actor,
