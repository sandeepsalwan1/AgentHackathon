...
2. Email the ezyVet API partner team to open the ezyVet public API track in parallel.
   - Contact: apisupport-ezyvet@idexx.com (scopes and access) or apisupport@ezyvet.com (per site additions). Partner application: https://www.ezyvet.com/become-a-partner
...
## Key contacts and fast track tips

The single biggest accelerator: bring a named clinic that already wants the integration. Both IDEXX and ezyVet applications ask for mutual clinic details. A real practice on Cornerstone that will be our pilot and reference moves us up the queue more than anything else. Line one up before or right after submitting.

IDEXX (Cornerstone, Neo, Animana, Data Services API):
- Start here: the Integration Request Form. https://www.idexx.com/en/veterinary/software-services/idexx-practice-management-software-integration-request-form/
- Animana API partner requests: IDEXX-Animana-API@idexx.com
- Data Services API docs, build against these now: https://io.datapointapi.com/documentation and https://dataservices-dev.idexx.com/
- Phone follow up if the form goes quiet (ask to be routed to integrations or partnerships):
  - Cornerstone software and hardware support: 1-800-695-2877
  - Neo software support: 1-800-296-7141
  - ezyVet support: 1-844-439-9838
  - Practice Solutions: 1-888-224-4408
  - IDEXX Reference Laboratories and VetConnect PLUS: 1-888-433-9987
- General IDEXX support directory: https://www.idexx.com/en/veterinary/support/support-contact/
- Note: there is no published integration team email. The form is the official front door, and the phone lines above are the practical way to chase a stalled request.

ezyVet (IDEXX owned):
- Partner application, commercial track: https://www.ezyvet.com/become-a-partner and https://developers.ezyvet.com/apply/commercial.html
- API questions and requesting additional scopes: apisupport-ezyvet@idexx.com
- Private API additions for specific sites: apisupport@ezyvet.com
- Support: https://support.ezyvet.com/ , phone 1-844-439-9838
- Ask the write back fee schedule in the first email so it does not surprise us later.

Antech (reference lab, owned by Mars):
- No public developer API contact found. Go through their PIMS or website support team.
- US support: 1-800-872-1001. The Website Support queue (HealthTracks, Antech Online, PIMS), 9am to 7pm ET Mon to Fri, is the right one for integration questions. Canada: 1-800-341-3440.
- Contact page, with department emails: https://www.antechdiagnostics.com/contact-us/
- Practical path: ask the pilot clinic to introduce us to their Antech account rep, who can route us to the HealthTracks or integrations team faster than the general line.

Fast track tips for IDEXX approval:
- Submit with a live website and a company domain email. Both visibly raise credibility.
- Answer commercially available as Yes, with a real and modest customer count, and state how many are on IDEXX PIMS. Partners whose IDEXX PIMS practices are already asking for the integration get prioritized.
- Keep the requested scope small and read mostly. A smaller surface means a faster security review. Offer to start read only.
- Have the security basics written down before the review: OAuth, encryption in transit and at rest, where data is stored, and revocable per clinic consent with a 30 day off switch.
- Build against the public spec and sandbox now so we can pass the certification demo quickly when we reach it.
- Reference the existing pattern (Otto and IDEXX's own Vello both read and write Cornerstone through Data Services) to show we understand the sanctioned model.
...
- IDEXX support contact directory (software support phone lines): https://www.idexx.com/en/veterinary/support/support-contact/
- IDEXX Data Services API external docs: https://io.datapointapi.com/documentation
- ezyVet become a partner: https://www.ezyvet.com/become-a-partner
- ezyVet commercial API application: https://developers.ezyvet.com/apply/commercial.html
- Antech contact page (department phone lines and emails): https://www.antechdiagnostics.com/contact-us/
