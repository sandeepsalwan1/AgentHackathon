...
1. Task create/update routes validate request payloads.
...
- Arrival intake request seam: `apps/internal/app/api/arrival-intake/_arrivalIntakeRequest.ts` hides public match/submit and staff desk mutations from the route.
