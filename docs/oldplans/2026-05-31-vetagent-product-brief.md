...
Archive status: old product brief. Current docs live in `../README.md`; keep this file for historical context only.
...
- `docs/oldplans/2026-05-31-4-person-execution-plan.md`
