import { z } from "zod";
import type { FieldErrors } from "./requestIntakeTypes";
...
export type ParsedRequestIntake = z.infer<typeof requestSchema>;
...
export function validateFields(value: ParsedRequestIntake) {
