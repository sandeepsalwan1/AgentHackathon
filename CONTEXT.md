...
- Arrival intake request: public match/submit actions, Arrival exception creation, room updates, checkout, and arrival settings mutation.
...
- Agent memory request: manager-authenticated memory query, create, correction, delete validation, actor metadata, and response projection.
